...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        'data-open:fade-in-0 data-closed:fade-out-0 fixed inset-0 z-50 bg-ink/20 duration-100 data-closed:animate-out data-open:animate-in',
        className
      )}
      {...props}
    />
